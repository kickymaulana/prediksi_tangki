    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <p><b>Petunjuk:</b></p>
                <ul>
                    <li>Tambahkan data tangki dan data produksi baru atau gunakan data tangki yang telah ada sebelum
                        melakukan
                        tambah
                        prediksi.</li>
                    ...
                    <li>Hindari menghapus data tangki yang sudah mempunyai data produksi.</li>
...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="card">
            <div class="card-body">
                <a href=<?php echo base_url("admin/tangki_tambah") ?> class="btn btn-primary" style="margin-bottom:15px">
                    Tambah Tanki</a>
...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="<?php echo base_url('admin/tangki_tambah'); ?>" class="form-horizontal" <div
                    class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="id_buku" id="id_buku"
                                value="<?php echo set_value('id_buku'); ?>" placeholder="Masukkan Nama Tangki">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nama_buku" id="nama_buku"
                                value="<?php echo set_value('nama_buku'); ?>" placeholder="Masukkan Nama Tangki">
                            <span class="badge badge-warning"><?php echo strip_tags(form_error('nama_buku')); ?></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="nama_alias" class="col-sm-2 col-form-label">Jenis Tangki</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="jenis_buku" id="jenis_buku"
                                value="<?php echo set_value('jenis_buku'); ?>" placeholder="Masukkan Jenis Tangki">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo base_url('admin/produksi_tambah'); ?>" class="form-horizontal">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="sisa_stok" class="col-sm-2 col-form-label">Persediaan</label>
                            <div class="col-sm-10">
