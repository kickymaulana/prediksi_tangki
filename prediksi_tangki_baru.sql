...
--
-- Host: mariadb
-- Generation Time: Sep 11, 2024 at 12:52 PM
...
(2, 2, 200, 20, 20, 20, 200, 20, 20, 20, 0, 1, 0, 1, 0, 0, 0, 1, 20, 20, 200, 20, 20, 20);
...
INSERT INTO `data_produksi` (`id_produksi`, `id_tangki`, `id_bulan`, `tahun`, `permintaan`, `sisa_stok`, `jumlah_produksi`) VALUES
...
(14, '30000', 9, 2020, 200, 20, 200),
(15, '30000', 3, 2020, 20, 20, 20);
...
INSERT INTO `hasil_prediksi` (`id_hasil_prediksi`, `id_tangki`, `id_bulan`, `tahun`, `permintaan`, `sisa_stok`, `prediksi_produksi`) VALUES
(1, 'BK001', 8, 2022, 2600, 440, 4104),
(2, '30000', 1, 2020, 20, 20, 20);
...
CREATE TABLE `tangki` (
  `id_tangki` char(5) NOT NULL,
  `nama_tangki` varchar(60) DEFAULT NULL,
  `jenis_tangki` varchar(60) DEFAULT NULL,
...
INSERT INTO `tangki` (`id_tangki`, `nama_tangki`, `jenis_tangki`, `jumlah_isi`) VALUES
('30000', 'Tangki Dani', 'JENIS TANGKI DANI', 20),
('BK001', 'Buku Tulis SIMA 58LS', 'Buku Tulis', 58);
...
ALTER TABLE `data_produksi`
  ...
  ADD KEY `FK_DATA_PRO_PENCATATA_BUKU` (`id_tangki`);
...
ALTER TABLE `hasil_prediksi`
  ...
  ADD KEY `FK_HASIL_PR_MEMPUNYAI_BUKU` (`id_tangki`);
...
--
ALTER TABLE `data_fuzzy`
  MODIFY `id_data_fuzzy` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `data_produksi`
--
ALTER TABLE `data_produksi`
  MODIFY `id_produksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
ALTER TABLE `data_produksi`
  ...
  ADD CONSTRAINT `FK_DATA_PRO_PENCATATA_BUKU` FOREIGN KEY (`id_tangki`) REFERENCES `tangki` (`id_tangki`);
...
ALTER TABLE `hasil_prediksi`
  ...
  ADD CONSTRAINT `FK_HASIL_PR_MEMPUNYAI_BUKU` FOREIGN KEY (`id_tangki`) REFERENCES `tangki` (`id_tangki`);
